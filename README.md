...
DXF viewer made using [dxf parser](https://github.com/skymakerolof/dxf), [threejs](https://github.com/mrdoob/three.js/) and [rtf]. It generates a threejs object that can be used in any scene. It also has some utility classes:
* Select
* Hover
* Snap
* Merger
